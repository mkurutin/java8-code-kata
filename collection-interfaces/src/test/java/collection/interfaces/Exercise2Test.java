...
public class Exercise2Test {
    ...
    public void mergeValues() {
         ...
         */
        BiFunction<Integer, Integer, Integer> remappingFunction = (currentValue, newValue) -> currentValue + newValue;
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<String, Integer, Integer> remappingFunction = (key, currentValue) -> currentValue + 1;
